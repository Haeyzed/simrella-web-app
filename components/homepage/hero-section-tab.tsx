...
import { updateHeroSection, createHeroSection } from "@/actions/sections"
...
export function HeroSectionTab({ heroSection, canEdit, onUpdate }: HeroSectionTabProps) {
  ...
  const [isActive, setIsActive] = useState(heroSection?.status === "published")
